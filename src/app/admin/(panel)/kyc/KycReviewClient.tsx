      ...
      <CardHeader className="border-b border-border/60 bg-muted/20">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-gradient text-sm font-semibold text-white">
              {initials}
            </span>
            <div>
            ...
            {application.questionnaire.length > 0 ? (
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                {application.questionnaire.map((q) => (
                  <div key={q.key} className="rounded-lg bg-muted/30 px-3 py-2">
